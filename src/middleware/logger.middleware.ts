...
const getResponseLog = (res: Response) => {
  ...
  res.end = (...chunk) => {
    ...
    // If I want response to be colorful I need to convert object to string
    const responseLog = {
      response: {
        statusCode: res.statusCode,
        // Current: JSON.parse(body) [[Object], [Object]]
        // Write body data: body [{email: test@gmail.com,...}]
